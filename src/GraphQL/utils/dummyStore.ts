export const UserWithMessageData = [
	{
		user_name: 'debotos',
		...
		products: [
			{
				...
				min_quantity: 1,
				min_quantity_extension: 'kg',
				price: 125,
				price_extension: '1 kg',
				available_now: true,
				retailable: true,
				description:
			...
			},
			{
				...
				quantity: 500,
				quantity_extension: 'piece',
				min_quantity: 1,
				min_quantity_extension: 'piece',
				price: 60,
				price_extension: '1 piece',
				available_now: true,
				retailable: false,
				description:
		...
		products: [
			{
				name: 'Chicken Eggs',
				quantity: 1000,
				quantity_extension: 'pcs',
				min_quantity: 1,
				min_quantity_extension: 'pcs',
				price: 122,
				price_extension: '12 pcs',
				available_now: true,
				retailable: true,
				description:
			...
			},
			{
				name: 'Milk',
				quantity: 100,
				quantity_extension: 'ltr',
				min_quantity: 1,
				min_quantity_extension: 'ltr',
				price: 65,
				price_extension: '1 ltr',
				available_now: true,
				retailable: true,
				description:
